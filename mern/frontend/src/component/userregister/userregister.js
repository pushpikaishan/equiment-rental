      ...
      <div className="register-form">
        <form id="registerForm" onSubmit={handleSubmit}>
          ...
          <div className={getFormGroupClass('email')}>
            ...
            {successMessages.email && <div className="success-message">{successMessages.email}</div>}
          </div>

          <div className={getFormGroupClass('nic')}>
            <label htmlFor="nic">
            ...
            {successMessages.nic && <div className="success-message">{successMessages.nic}</div>}
          </div>
          ...
          <div className={getFormGroupClass('password')}>
            ...
            <div className={getPasswordStrengthClass()}>
              ...
              <span className="strength-text">
                Password strength: <span id="strengthLabel">{passwordStrength.label}</span>
              </span>
            </div>
          ...
          <div className="terms-wrapper">
            ...
            {errors.terms && <div className="error-message" style={{ marginTop: 5 }}>{errors.terms}</div>}
          </div>

          <button type="submit" className={`register-btn ${isLoading ? 'loading' : ''}`} disabled={isLoading}>
            {isLoading && <span className="spinner" style={{ display: 'inline-block' }}></span>}
